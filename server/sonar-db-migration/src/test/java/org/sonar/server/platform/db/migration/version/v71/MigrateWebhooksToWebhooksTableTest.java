...
public class MigrateWebhooksToWebhooksTableTest {
  ...
  public void execute_delete_webhooks_of_components_which_is_not_a_project(int webhookCount, String scope, String qualifier) throws SQLException {
    Project project = insertComponent(scope, qualifier);
    insertProjectWebhookProperties(project, webhookCount);
  ...
  private Project insertProject() {
    return insertComponent(Scopes.PROJECT, Qualifiers.PROJECT);
  }

  private Project insertComponent(String scope, String qualifier) {
  ...
  private static final class Webhook {
    ...
    private Webhook(String name, String url, @Nullable String organizationUuid, @Nullable String projectUuid, long createdAt) {
      this.name = name;
      this.url = url;
  ...
  private static class Row {
    ...
    private Row(String uuid, String name, String url, @Nullable String organizationUuid, @Nullable String projectUuid, long createdAt, long updatedAt) {
      this.uuid = uuid;
      this.name = name;
      this.url = url;
      this.organizationUuid = organizationUuid;
